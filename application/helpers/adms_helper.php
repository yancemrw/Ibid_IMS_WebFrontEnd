...
function linkservice($services) {
	...
	*/
	...
	$AMSAUCTION    = ('AMSAUCTION' === strtoupper($services)) ? $return = 'https://ibid.astra.co.id/backend/serviceams/auction/api/' : '';
	$AMSLOT    = ('AMSLOT' === strtoupper($services)) ? $return = 'https://ibid.astra.co.id/backend/serviceams/lot/api/' : '';
