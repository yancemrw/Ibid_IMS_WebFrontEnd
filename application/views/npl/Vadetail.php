			...
			<div class="col-md-12 text-center">
             ...
             <div class="box-virtual-account">
                 ...
                 <div class="box-v col-md-6">
                     <p>Nomor tagihan:</p>
                     <span class="purple">IBID18118E1SXQINV</span>
                    <p>Jumlah Tagihan<p>
                    <span>Rp 500.000,-</span>
                    <p>Nomor Rekening Virtual Account Mandiri:</p>
                    <span>8910895333216739</span>
                 </div>
             </div> 
                                ...
                                <div class="panel panel-default">
                                   ...
                                   <div id="collapse-rules1" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                      <div class="panel-body bg-grey">
                                         <p>Pengunjung dapat mencari kendaraan yang diinginkan di website dari menu "cari kendaraan" dan hasil pencarian kendaraan dapat didownload menggunakan tombol "download" pada halaman cari kendaraan.</p>
                                      </div>
                                   </div>
                                </div>
                                <div class="panel panel-default">
                                   ...
                                   <div id="collapse-rules2" class="panel-collapse collapse" aria-expanded="false">
                                      <div class="panel-body bg-grey">
                                         <p>Pengunjung dapat mengetahui jadwal lelang terdekat di website dari menu "jadwal lelang" dan untuk mengetahui lokasi lelang dapat dilihat di setiap halaman informasi detail kendaraan.</p>
                                      </div>
                                   </div>
                                </div>
                             </div>
