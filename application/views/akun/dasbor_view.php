                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group floating-label">
                                    <input type="name" name="" class="form-control input-custom">
                                    <label class="label-schedule">Nama</label>
                                 </div>
                                 <div class="form-group floating-label">
                                    <input type="email" name="" class="form-control input-custom" placeholder="">
                                    <label class="label-schedule">Email *</label>
                                 </div>
                                 <div class="form-group floating-label">
                                    <input type="text" name="" class="form-control input-custom" placeholder="">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    <div class="input-group date">
                                       <input type="text" class="form-control input-custom empty" placeholder="Tanggal Lahir">
