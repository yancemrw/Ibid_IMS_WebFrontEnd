...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url('assetsfront/css/style.css?v4') ?>">
   <link rel="stylesheet" type="text/css" href="<?php echo base_url('assetsfront/css/responsive.css?v5') ?>">
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url('assetsfront/css/overwrite.css?v8'); ?>">
