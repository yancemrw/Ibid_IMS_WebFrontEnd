...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url('assetsfront/css/style.css?v3') ?>">
   ...
   })(window,document,'script','dataLayer','GTM-NLSP55K');
   </script>
   <!-- End Google Tag Manager -->
</head>
<body class="bg-grey">
   <!-- Google Tag Manager (noscript) -->
   <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NLSP55K" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
