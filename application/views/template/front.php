               ...
               <div class="modal-body clearfix">
                  <div class="col-md-6 col-sm-6">
                     <form class="form-login">
                        <div class="form-group floating-label">
                           <input type="text" class="form-control input-custom" id="">
                  ...
                  <div class="col-md-6 col-sm-6">
                     <div class="login-socialmedia">
                        <a href="" class="login-facebook"><i class="ic ic-facebook"></i> Masuk melalui facebook</a>
                        <a href="" class="login-twitter"><i class="ic ic-twitter"></i> Masuk melalui twitter</a>
                        <a href="" class="login-google"><i class="ic ic-Google"></i> Masuk melalui google</a>
                        <a href="" class="login-linkedin"><i class="ic ic-linkedin"></i> Masuk melalui Linkedin</a>
                     </div>
                  </div>
               </div>
            </div>
